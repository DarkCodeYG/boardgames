        ...
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className="shrink-0 mt-3 pt-3 border-t border-stone-700">
            ...
            {room.turnState === 'result' && room.lastResult && (
              <div
                className={`rounded-2xl p-4 ${room.lastResult.correct ? 'bg-emerald-900' : 'bg-red-900'}`}
              >
                <div className="text-2xl font-black text-center mb-2">
                  {room.lastResult.correct ? txt.correct : txt.wrong}
                </div>
                <div className="text-sm text-center mb-3 space-y-0.5">
                  ...
                  <p className="text-stone-300">
                    {txt.guessLabel}: <span className="font-black text-yellow-300">{formatTileNumber(room.lastResult.guessedNumber)}</span>
                  </p>
                </div>
                <div className="flex gap-2">
